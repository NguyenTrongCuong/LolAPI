...
public class ClientCustomAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	private ApplicationProperties properties;
	private AuthenticationManager authManager;
	
	public ClientCustomAuthenticationFilter(AuthenticationManager authManager, ApplicationProperties properties) {
		this.setFilterProcessesUrl("/api/v1/client/login");
